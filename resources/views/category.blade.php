                                ...
                                <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp" data-wow-delay="0.4s">
                                    ...
                                    <div class="card-body">
                                       <div class="card-header text-uppercase">
                                        ...
                                        <p class="card-text small">Hike, Explore, Thrive: Your Guide to Outdoor Adventure" is an immersive journey into nature's wonders. Uncover hidden trails, embrace challenges...</p>
                                    </div>
                                </div>
                            </div>
                            <!-- single card -->
                                ...
                                <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp" data-wow-delay="0.4s">
                                    ...
                                    <div class="card-body">
                                       <div class="card-header text-uppercase">
                                        ...
                                        <p class="card-text small">Adventures in Every Step" is an exhilarating journey through the wilderness, weaving captivating stories of exploration and self-discovery. With each...</p>
                                    </div>
                                </div>
                            </div>
                            <!-- single card -->
                                ...
                                <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp" data-wow-delay="0.4s">
                                    ...
                                    <div class="card-body">
                                       <div class="card-header text-uppercase">
                                        ...
                                        <p class="card-text small">Trails in Nature's Masterpiece captures the essence of our connection to the natural world, highlighting the impact of human presence through-provoking...</p>
                                    </div>
                                </div>
                            </div>
                            <!-- single card -->
                                ...
                                <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp" data-wow-delay="0.4s">
                                    ...
                                    <div class="card-body">
                                       <div class="card-header text-uppercase">
                                        ...
                                        <p class="card-text small">Your Spirit with Nature invites you on a transformative journey through scenic landscapes. Immerse yourself in the beauty of the great outdoors and...</p>
                                    </div>
                                </div>
                            </div>
                            <!-- single card -->
                                ...
                                <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp" data-wow-delay="0.4s">
                                    ...
                                    <div class="card-body">
                                      ...
                                      <h5 class="fs-4 card-title"><a href="article" class="blog-title">Into the Wilderness: Hiking for Mind, Body, and Soul</a></h5>
                                        ...
                                        <p class="card-text small">Embark transformative journey with Into the Wilderness: Hiking for Mind and Soul. This captivating exploration not only invigorates your body but also...</p>
                                    </div>
                                </div>
                            </div>
                            <!-- single card -->
                                ...
                                <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp" data-wow-delay="0.4s">
                                    ...
                                    <div class="card-body">
                                       <div class="card-header text-uppercase">
                                        ...
                                        <p class="card-text small">Epic Hiking Journeys and Trail Tales invites readers to traverse breathtaking landscapes, weaving personal narratives with the allure of alpine...</p>
                                    </div>
                                </div>
                            </div>
                            <!-- single card -->
                                ...
                                <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp" data-wow-delay="0.4s">
                                    ...
                                    <div class="card-body">
                                       <div class="card-header text-uppercase">
                                        ...
                                        <p class="card-text small">Mastering the Art of Hiking is essential guide for outdoor enthusiasts, offering concise yet comprehensive insights on trail, gear essentials...</p>
                                    </div>
                                </div>
                            </div>
                            <!-- single card -->
                                ...
                                <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp" data-wow-delay="0.4s">
                                    ...
                                    <div class="card-body">
                                       <div class="card-header text-uppercase">
                                        ...
                                        <p class="card-text small">Expert Hiking Tips'' is an indispensable guide, navigating adventurers through challenging terrains with seasoned advice. Elevate your hiking prowess...</p>
                                    </div>
                                </div>
                            </div>
                            <!-- single card -->
                                ...
                                <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp" data-wow-delay="0.4s">
                                    ...
                                    <div class="card-body">
                                       <div class="card-header text-uppercase">
                                        ...
                                        <p class="card-text small">Essential Skills and Techniques" is a comprehensive guide that equips outdoor enthusiasts with vital hiking skills. From navigation strategies to survival...</p>
                                    </div>
                                </div>
                            </div>
                            <!-- single card -->
                                ...
                                <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp" data-wow-delay="0.4s">
                                    ...
                                    <div class="card-body">
                                       <div class="card-header text-uppercase">
                                        ...
                                        <p class="card-text small">Hiking Stories and Advice" invites readers on a breath taking journey through nature's wonders. This captivating book combines vivid hiking tales with...</p>
                                    </div>
                                </div>
                            </div>
                            <!-- single card -->
