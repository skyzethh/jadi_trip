...
<head>
    ...
    <meta name="description" content="Jadi Trip is your ultimate destination for travel inspiration, tips, and guides. Discover hidden gems, plan your next adventure, and make the most out of your travels with our expertly curated content. Join our community of wanderers and explore the world with Jadi Trip.">
                    ...
                    <div class="author-about mb-40 ">
                        <div class="text-center">
                            <div class="author-iamge">
                                <a href="about"><img src="assets/images/placeholder.svg" data-src="assets/images/about-image-1.png" alt="author-iamge"></a>
                            </div>
            ...
            <div class="offcanvas offcanvas-end offcanvasmobile-menu" id="offcanvasmobile-menu" data-bs-backdrop="static" tabindex="-1">
                ...
                <div class="offcanvas-body d-flex justify-content-start">
                    <ul class="navbar-nav custom-navbar-nav mb-2  mb-lg-0 hover-menu">
                        <li class="nav-item dropdown">
                            <a class="nav-link d-flex gap-2 align-items-center" aria-current="page" href="blog" aria-label="nav-links">
                                Destinasi
                            </a>
                        </li>
                        <li class="nav-item dropdown">
                        ...
                        <div class="container">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-100">
                                  ...
                                  <li class="breadcrumb-item active" aria-current="page">Backpacking In Lake Clark National Park With Alaska Alpine Adventures</li>
                                </ol>
                            </nav>
                            <!-- breadcrumb -->
                            <div class="row justify-content-center">
                                <div class="col-md-10">
                                    ...
                                    <div class="text-center py-30">
                                        <h2 class="section-banner-title text-white pb-30 ">Backpacking In Lake Clark National Park With Alaska Alpine Adventures</h2>
                                        <div class="d-flex gap-20 flex-wrap justify-content-center" >
                                            <span class="text-white">3 Comments</span>
                                            <span class="text-white">January 12,  <span class="dynamic-year"> </span>.</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row justify-content-end custom-row-gap">
                                ...
                                <div class="sticky-elements">
                                    ...
                                    <div class="sidebar-style d-none d-xl-block">
                                        <div class="author-details mb-lg-60 mb-40">
                                            ...
                                            <h6 class="text-end" ><a href="about" class="author-name">Mike Aiden</a></h6>
                                            <div class="author-image">
                                                <img src="assets/images/placeholder.svg" data-src="assets/images/about-image-1.png" alt="about-image">
                                            </div>
                                        </div>
                                        <div class="sidebar-social">
                                            ...
                                            <a href="https://www.pinterest.com" class="pinterest"><i class="fa-brands fa-pinterest-p"></i></a>
                                            <a href="https://twitter.com" class="twitter"><svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M15.8092 15.98H11.1569L6.89801 9.78339L1.56807 15.98H0.19043L6.28619 8.89157L0.19043 0.0195312H4.84276L8.87486 5.88989L13.9234 0.0195312H15.301L9.48808 6.77751L15.8092 15.98ZM11.8079 14.9929H13.9234L4.18054 1.05696H2.06508L11.8079 14.9929Z"></path>
                                                </svg>
                                            </a>
                            ...
                            <div class="col-xl-7">
                                ...
                                <div class="article-blog-content mb-lg-0 mb-20">
                                    <p class="mb-30 mb-lg-60">The third Bearfoot Theory group tour is in the books. Explore Lake Clark National Park, one of the most remote parks in the country in this review of my 10-day backpacking trip with Alaska Alpine Adventures.</p>
                                                ...
                                                <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                                  <div class="accordion-body">
                                                    <ol id="navbar-example3"  class="table-of-content-body">
                                                        ...
                                                        <li>
                                                            <h3><a href="#traveltipsandhacks">Travel Tips and Hacks</a></h3>
                                                        </li>
                                                        <li>
                                                            <h3><a href="#outdoor-and-adventure">Outdoor and Adventure</a></h3>
                                                            <ul>
                                                                <li><h4><a href="#Kayaking-Chronicles-Paddling-through-PristineWaters">Kayaking Chronicles - Paddling through Pristine Waters</a></h4></li>
                                                                <li><h4> <a href="#hiking-havens">Hiking Havens - Trails and Treks in the Alaskan Wilderness</a></h4></li>
                                                                <li><h4> <a href="#Camping-by-the-Shores">Camping by the Shores - Sleeping Under the Alaskan Stars</a></h4></li>
                                                                <li><h4><a href="#Wildlife-Safari">Wildlife Safari - Encounters with Alaska's Untamed Residents</a></h4></li>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <h3><a href="#photography-and-videography">Photo and Video Gallery</a></h3>
                                                        </li>
                                                        <li>
                                                            <h3><a href="#accommodation-reviews">Accommodation Reviews</a></h3>
                                                        </li>
                                                        <li>
                                    ...
                                    <div data-bs-spy="scroll" data-bs-target="#navbar-example3" data-bs-offset="0" data-bs-smooth-scroll="true" tabindex="0">
                                        ...
                                        <p class="pb-20 pb-lg-30 ">This summer, I offered the third-ever Bearfoot Theory group adventure. This time, myself and a group of Bearfoot Theory readers ventured into the Alaskan wilderness for 10 days of backpac. Led by our guides from <a href="#">Alaska Alpine Adventures,</a> our trip in Lake Clark offered a true Alaska experience in every sense.</p>
                                        ...
                                        <p class="pb-20 pb-lg-30 ">In this blog post, I share all that we got to see, do, and learn on this epic adventure, as well as a review of Alaska Alpine Adventures for those of you looking to explore Alaska’s backcountry.</p>


                                        <!-- article blog list -->

                                        <h3 id="traveltipsandhacks" class="mb-10 article-post-heading ">Travel Tips and Hacks</h3>
                                        <ul class="">
                                            <li >
                                                <p>Book in Advance: Accommodations can be limited, so book well in advance, especially is at during the peak season.</p>
                                            </li>
                                            <li>
                                                <p>Bear Safety: Familiarize yourself with bear safety protocols, including proper food storage on and carrying bear spray.</p>
                                            </li>
                                            <li>
                                                <p>Water Activities: Consider kayaking or boating to explore the lake's shoreline. Rentals are of available, or you can bring your own gear.</p>
                                            </li>
                                            <li>
                                                <p>Golden Hour Shots: Take advantage of the extended golden hour in Alaska for stunning and photography. Sunrise and sunset offer magical lighting.</p>
                                            </li>
                                            <li>
                                                <p>Emergency Preparedness: Be prepared for and emergencies by carrying a basic first aid kit, communication devices, and knowing the location of the nearest ranger station.</p>
                                            </li>
                                        </ul>
                                        <p class="mb-20 mb-lg-30">By following these travel tips and hacks, you'll be well-prepared to be immerse yourself in the natural beauty and tranquillity of Lake Clark, creating memories that will last a lifetime.</p>
                                        <div class="single-blog  pb-20">
                                            <!-- single blog -->
                                            <div class="blog-image border-rarius-14">
                                                <img src="assets/images/placeholder.svg" data-src="assets/images/blog/explore-image-29.jpg" class="border-rarius-14" alt="img-top">
                                            </div>
                                        ...
                                        <h3 id="outdoor-and-adventure"  class="mb-10 article-post-heading  ">Outdoor and Adventure</h3>

                                        <p class="mb-lg-30 mb-20 ">Lake Clark, nestled within the heart of Alaska's untamed wilderness, is a haven for outdoor enthusiasts and adventure seekers alike. Surrounded by the rugged peaks of the Alaska Range, this pristine lake, a centerpiece of the Lake Clark National Park and Preserve, beckons with its crystal-clear waters and awe-inspiring landscapes.</p>
                                        <div class="single-article-post-style">

                                            <div class="single-article-post-grid">
                                                <div class="single-article-post-image pb-20">
                                                    <div class="iamge-wrapper border-rarius-14 image-hover-effect">
                                                        <img src="assets/images/placeholder.svg" data-src="assets/images/article/post-iamge-1.jpg" class="card-img-top border-rarius-14" alt="img-top">
                                                    </div>

                                                </div>
                                                <div class="single-article-post-content">
                                                    <div class="single-article-post-style">
                                                        <h4 id="Kayaking-Chronicles-Paddling-through-PristineWaters" class="article-post-sub-heading mb-10 mb-md-20">Kayaking Chronicles - Paddling through Pristine Waters</h4>
                                                        <p class="mb-lg-20 mb-10">Embark on an exhilaarataing journey through the Kayaking Chronicles of Lake Clark, where is the crystal-clear waters beckons adventure seekers to paddle through pristine landscape. The allure of the Lake Clark lies not just in its transparency but in the sereeeeeenity that is envelops each stroke. The Lake Clark's Hiking Havens adventureres into an untou realm of rugged beauty.</p>

                                                        <h4 id="hiking-havens" class=" article-post-sub-heading mb-10">Hiking Havens - Trails and Treks in the Alaskan Wilderness</h4>
                                                        <p class="mb-lg-20 mb-10">Lake Clark's Hiking Havens beckon adventure into an untouched realm of ruggded beauty. Trails wind through vasted tundra, revealing breathtaking vistats of snow-capped peaks and pristine lakes.snow-capped peaks and pristine lakes.</p>
                                                    </div>
                                                </div>
                                        ...
                                        <h4 id="Camping-by-the-Shores" class="article-post-sub-heading mb-10 ">Camping by the Shores - Sleeping Under the Alaskan Stars</h4>
                                        <p class="pb-20 ">Experience the magic of camping along Lake Clark's pristine shores. Set up your tent under Alaskan sky, where the midnight sun illuminates rugged landscapes, creating unforgettable lakeside memories.</p>
                                        ...
                                        <div class="article-post-gallery-grid pb-30">
                                            <div class="div1 image-hover-effect">
                                                <img src="assets/images/placeholder.svg" data-src="assets/images/categories/category.jpg" class="border-rarius-14" alt="img-top">

                                            </div>
                                            <div class="div2 image-hover-effect">
                                                <img src="assets/images/placeholder.svg" data-src="assets/images/categories/category8.jpg" class="border-rarius-14" alt="img-top">

                                            </div>
                                            <div class="div3 image-hover-effect">
                                                <img src="assets/images/placeholder.svg" data-src="assets/images/article/post-iamge-2.jpg" class="border-rarius-14" alt="img-top">

                                            </div>
                                        </div>


                                        <p class="mb-lg-30 mb-10">Experience the magic of camping along Lake Clark's pristine shores. Set up your tent under the vast Alaskan sky, where the midnight sun illuminates rugged landscapes, creating unforgettable lakeside memories.</p>

                                        <h4  id="Wildlife-Safari" class="mb-10 article-post-sub-heading ">Wildlife Safari - Encounters with Alaska's Untamed Residents</h4>
                                        <p class="mb-lg-60 mb-md-30 mb-10">Embark on a wildlife safari at The Lake Clark, Alaska, where is untamed brown bear roam freely, eagles soar overhead, and moose graze by the shores—a captivating envvcounter with Alaska's wild residents. Lake Clark, a haven for outdoor enthusiasts, concludesss as a realm of unspoiled wilderness. From kayaking pristine waters to know summiting majestic peaks, it's an untamed adventure etched in enduring memories.</p>
                                        <h6 id="photography-and-videography" class="mb-lg-20 mb-10 article-post-heading ">Photo and Video Gallery</h6>
                                        <!-- article-slider -->
                                        <div class="article-slider-wrapper-main">

                                            <div class="swiper article-slider-wrapper">
                                                <div class="swiper-wrapper">
                                                  <div class="swiper-slide border-rarius-14 article-slider-single">
                                                    <img class="border-rarius-14" src="assets/images/placeholder.svg" data-src="assets/images/blog/explore-image-29.jpg" alt="Beach">

                                                    <a href="https://www.youtube.com/embed/TKnufs85hXk" data-vbtype="iframe" class="popup-youtube play-icon play-icon-effect">
                                                        <i class="fa-light fa-circle-play"></i>
                                                    </a>
                                                  </div>
                                                  <div class="swiper-slide border-rarius-14 article-slider-single">
                                                    <img class="border-rarius-14" src="assets/images/placeholder.svg" data-src="assets/images/blog/explore-image-28.jpg" alt="deserts">
                                                  </div>
                                                  <div class="swiper-slide border-rarius-14 article-slider-single">
                                                    <img class="border-rarius-14" src="assets/images/placeholder.svg" data-src="assets/images/blog/explore-image-54.jpg" alt="Forest">
                                                  </div>
                                                  <div class="swiper-slide border-rarius-14 article-slider-single">
                                                    <img class="border-rarius-14" src="assets/images/placeholder.svg" data-src="assets/images/blog/explore-image-27.jpg" alt="beach-iamge">
                                                  </div>
                                                  <div class="swiper-slide border-rarius-14 article-slider-single">
                                                    <img class="border-rarius-14" src="assets/images/placeholder.svg" data-src="assets/images/blog/explore-image-15.jpg" alt="hill">
                                                    <a href="https://www.youtube.com/embed/TKnufs85hXk" data-vbtype="iframe" class="popup-youtube play-icon play-icon-effect">
                                                        <i class="fa-light fa-circle-play"></i>
                                                    </a>
                                                  ...
                                                  <div class="swiper-slide border-rarius-14 article-slider-single">
                                                    <img class="border-rarius-14" src="assets/images/placeholder.svg" data-src="assets/images/blog/explore-image-54.jpg" alt="desert-iamge">
                                                  </div>

                                                </div>
                                                <div class="swiper-slide-button-wrapper">

                                                    <div class="swiper-slide-button-prev"><i class="fa-solid fa-angle-left"></i></div>
                                                    <div class="swiper-slide-button-next"><i class="fa-solid fa-angle-right"></i></div>
                                                </div>
                                            </div>
                                            <div class="row justify-content-center">
                                                <div class="col-md-8">
                                                    <div class="swiper article-slider-thumb-wrapper">
                                                        <div class="swiper-wrapper">
                                                            <div class="swiper-slide article-slider-thumb-single">
                                                                <img src="assets/images/placeholder.svg" data-src="assets/images/blog/explore-image-29.jpg" alt="slide-image">
                                                                <span class="play-icon">
                                                                    <i class="fa-light fa-circle-play"></i>
                                                                </span>
                                                            </div>
                                                            <div class="swiper-slide article-slider-thumb-single">
                                                                <img src="assets/images/placeholder.svg" data-src="assets/images/blog/explore-image-28.jpg" alt="slide-image-two">
                                                            </div>
                                                            <div class="swiper-slide article-slider-thumb-single">
                                                                <img src="assets/images/placeholder.svg" data-src="assets/images/blog/explore-image-54.jpg" alt="slide-image-three">
                                                            </div>
                                                            <div class="swiper-slide article-slider-thumb-single">
                                                                <img src="assets/images/placeholder.svg" data-src="assets/images/blog/explore-image-27.jpg" alt="slide-image-four">
                                                            </div>
                                                            <div class="swiper-slide article-slider-thumb-single">
                                                                <img src="assets/images/placeholder.svg" data-src="assets/images/blog/explore-image-15.jpg" alt="slide-image-four">
                                                                <span class="play-icon">
                                                                    <i class="fa-light fa-circle-play"></i>
                                                                </span>
                                                            </div>
                                                            <div class="swiper-slide article-slider-thumb-single">
                                                                <img src="assets/images/placeholder.svg" data-src="assets/images/blog/explore-image-54.jpg" alt="slide-image-five">
                                                            </div>
                                        ...
                                        <h3 id="accommodation-reviews" class="mb-10 article-post-heading ">Accommodation Reviews</h3>
                                        <p class="mb-lg-30  mb-10">The Lake Clark's accommodation options blend comfort with the untamed Alaskan wilderness. Lakeside retreats offer panoramic views, allowing guests to wake up to the serenity of nature. Cozy cabins, equipped with modern amenities, provide a refuge after day of outdoor adventure.</p>
                                        <div class="blog-image-wrapper mb-lg-60 mb-30">
                                            <div class="blog-image image-hover-effect-2">
                                                <img src="assets/images/placeholder.svg" data-src="assets/images/blog/explore-image-53.jpg" class=" full-image border-rarius-14" alt="img-top">
                                            </div>

                                            <div class="blog-image image-hover-effect-2">
                                                <img src="assets/images/placeholder.svg" data-src="assets/images/blog/explore-image-54.jpg" class=" full-image border-rarius-14" alt="img-top">
                                            </div>
                                        </div>

                                        <p class="mb-lg-60  mb-md-30 mb-10">Camping by the shores offers a more immersive experience under the midnight sun or dancing Northern Lights. Whether opting for luxury lodges or embracing the simplicity of camping, Lake Clark ensures a harmonious coexistence with nature, making each night's stay an integral part of the broader Alaskan adventure.</p>

                                        <h3 id="destination" class="article-post-heading mb-lg-20 mb-10 ">Destination Guides</h3>
                                        <div class="google-map pb-40">
                                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d9341.018597461838!2d-4.432307619358653!3d54.175565819955594!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x486384adaa7f6fd3%3A0x1fe2385732f12c3a!2sGroudle%20Beach!5e0!3m2!1sen!2sbd!4v1711792810684!5m2!1sen!2sbd"  allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                        </div>


                                        <h3 id="travelchallenges" class="article-post-heading mb-lg-20">Travel Challenges</h3>
                                        <p class="mb-lg-20 mb-10">Embarking on the Lake Clark travel challenge unveils both the beauty and demands of Alaska's wilderness. Navigating its untamed landscape requires resilience against unpredictable weather, rigorous hiking, and encounters with wildlife.</p>
                                        <p class="mb-lg-60  mb-md-30 mb-20">The challenge lies immersing oneself in the raw element of nature, embraing the ruged terrains, and adapting the wild, creating an unforgettable expedition that tests both physical endurance and a deep connection with the unparalleled beauty of Lake Clark's outdoor wonders.</p>

                                        <h3 id="conclusion"  class="article-post-heading mb-lg-20 mb-10 ">Conclusion</h3>
                                        <p class="mb-lg-60  mb-30">In the heart of Alaska, Lake Clark beckons with untamed beauty and outdoor wonders. As the journey through this the wilderness concludes, memories linger—kayaking crystal-clear waters, hiking amidst the towering peaks, and witnessing the unique harmony of wildlife. Lake Clark's pristine charm and rugged landscapes imprint an indelible mark, inviting all who venture here to become part of its tale. The adventure transcends a mere trip; it's a transformative experience, a communion with nature's grandeur that leaves travelers with a profound appreciation for the raw and unyielding beauty of Alaska's Lake Clark National Park and Preserve.</p>
                                ...
                                <div class="sticky-elements">
                                    <div class="d-flex flex-column gap-lg-60 gap-30">
                                        ...
                                        <div class="add-iamge d-none d-xl-block wow fadeInUp" data-wow-delay="0.4s">
                                            <a href="#"><img src="assets/images/add.png" class="img-fluid" alt="img"></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="mini-card-slider-wrapper py-lg-100 py-md-60 py-30">
                                    ...
                                    <div class="swiper mini-card-slider">
                                                ...
                                                <div class="card card-style-10 card-border">
                                                    <div class="d-flex align-items-center gap-lg-20 gap-10 ">
                                                        <div class="card-image-wrapper-style-2 image-hover-effect-2">
                                                            <a href="article">
                                                                <img src="assets/images/placeholder.svg" data-src="assets/images/feature-images/feature-image-1.jpg" alt="img-top">
                                                            </a>
                                                        </div>
                                                        <div class="card-body p-0  mt-auto">
                                                            <h5 class="card-title lead fw-extrabold"><a href="about" class="blog-title">Quick and Easy Flaky  Pastry for Tasty Breakfast</a></h5>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="swiper-slide">
                                                ...
                                                <div class="card card-style-10 card-border">
                                                    <div class="d-flex align-items-center gap-lg-20 gap-10 ">
                                                        <div class="card-image-wrapper-style-2 image-hover-effect-2">
                                                            <a href="article">
                                                                <img src="assets/images/placeholder.svg" data-src="assets/images/feature-images/feature-image-2.jpg" alt="img-top">
                                                            </a>
                                                        </div>
                                                        <div class="card-body p-0  mt-auto">
                                                            <h5 class="card-title lead fw-extrabold"><a href="article" class="blog-title">Quick and Easy Flaky  Pastry for Tasty Breakfast</a></h5>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- card card-style-10 -->
                                                    ...
                                                    <div class="d-flex align-items-center gap-lg-20 gap-10 ">
                                                        <div class="card-image-wrapper-style-2 image-hover-effect-2">
                                                            <a href="article">
                                                                ...
                                                                <img src="assets/images/placeholder.svg" data-src="assets/images/feature-images/feature-image-4.jpg" alt="img-top">
                                                            </a>
                                                        </div>
                                                        <div class="card-body p-0  mt-auto">
                                                            <h5 class="card-title lead fw-extrabold"><a href="article" class="blog-title">Quick and Easy Flaky  Pastry for Tasty Breakfast</a></h5>
                                        ...
                                        <div class="swiper-slide-button-wrapper">
                                            ...
                                            <div class="mini-card-button-prev"><i class="fa-solid fa-arrow-left"></i><span>Previous</span></div>
                                            <div class="mini-card-button-next"><span>Next</span> <i class="fa-solid fa-arrow-right"></i>  </div>
                                        </div>
                                ...
                                <div class="comments-wrapper pb-lg-60 pb-30">
                                    ...
                                    <div class="comment">
                                        ...
                                        <div class="main-comment mb-30">
                                            <div class="d-flex gap-20">
                                                <div class="comment-iamge">
                                                    <img src="assets/images/placeholder.svg" data-src="assets/images/man-02.jpg" alt="image">
                                                </div>
                                                <div class="comment-content">
                                                    <h5><a href="#" class="comment-name">Liam Adams</a></h5>
                                                    <span class="timestamp">January 12,  <span class="dynamic-year"> </span>. at 10am</span>
                                                    <p>Your vivid descriptions and captivating storytelling make me feel like I'm right there, exploring each destination alongside you. Your travel blog is a constant source of inspiration for my own adventures. Keep the amazing content coming!</p>
                                        ...
                                        <div class="reply mb-30">
                                            <div class="d-flex gap-20">
                                                <div class="comment-iamge">
                                                    <img src="assets/images/placeholder.svg" data-src="assets/images/about-image-1.png" alt="image">
                                                </div>
                                                <div class="comment-content">
                                                    <h5><a href="#" class="comment-name">Liam Adams <span>(Author)</span></a></h5>
                                                    <span class="timestamp">January 12,  <span class="dynamic-year"> </span>. at 10am</span>
                                                    <p>Thank you so much for your kind words! It warms my heart to know that my travel tales inspire your own adventures. Your support means the world, and I'm thrilled to continue sharing the journey with you. Stay tuned for more exciting experiences ahead</p>
                                                    <button type="submit" class="btn btn-reply">Reply</button>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="main-comment mb-30">
                                            <div class="d-flex gap-20">
                                                <div class="comment-iamge">
                                                    <img src="assets/images/placeholder.svg" data-src="assets/images/man-03.jpg" alt="image">
                                                </div>
                                                <div class="comment-content">
                                ...
                                <div class="comment-form-wrapper">
                                    ...
                                    <form class="comment-from">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="name">Name <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <div class="form-group">
                                                    <label for="email">Email <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M5 1V9M8 2L2 8M9 5H1M8 8L2 2" stroke="#4C9BB3" stroke-width="0.8" stroke-linecap="round" stroke-linejoin="round"/>
                                                        </svg></label>
                                        ...
                                        <div class="form-check mb-lg-40 mb-20">
                                            ...
                                            <label class="form-check-label" for="Check1">Save my name, email, and website in this browser for the next time I comment. </label>
                                        </div>
                        ...
                        <div class="row custom-row-gap">
                            <div class="col-lg-4">
                                ...
                                <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp" data-wow-delay="0.4s">
                                    <div class="card-image-wrapper">
                                        <a href="article"><img src="assets/images/placeholder.svg" data-src="assets/images/blog/explore-image-21.jpg" class="card-img-top" alt="Lake"></a>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text small">Nature Peaceful Miracle captivate with serene reflection, gentle ripples, and harmonious symphony. A tranquil haven where beauty meets tranquility...</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp" data-wow-delay="0.4s">
                                    <div class="card-image-wrapper">
                                       <a href="blog"> <img src="assets/images/placeholder.svg" data-src="assets/images/blog/explore-image-30.jpg" class="card-img-top" alt="Forest"></a>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text small">Nature's Healing Sanctuary invite weary souls to immerse in the embrace  ancient tree, where whispers of the wind and rustling leaves orchestrate...</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="card card-style-2 card-border mb-lg-40 mb-20 wow fadeInUp" data-wow-delay="0.4s">
                                    <div class="card-image-wrapper">
                                       <a href="blog"> <img src="assets/images/placeholder.svg" data-src="assets/images/blog/explore-image-47.jpg" class="card-img-top" alt="img-top"></a>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h5 class="fs-4 card-title"><a href="article" class="blog-title">Seaside Serenity: Beachside Beauty Uncovered</a></h5>
                                        ...
                                        <p class="card-text small">Beachside Beauty Uncovered invites you to a tranquil escape, where the rhythmic waves meet the golden shore. Discover serenity in the embrace...</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container">
                                ...
                                <div class="col-lg-6">
                                    <div class="social-icons  d-flex align-items-center justify-content-lg-end gap-20">
                                        ...
                                        <a href="https://www.linkedin.com">
                                            <span class="text-white">
                                                <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M5.10708 6.41797H1.4502V16.6369H5.10708V6.41797Z" fill="#4C9BB3"/>
                        ...
                        <div class="footer-bottom-contents mt-30 text-white">
                             ...
                             <div class="d-flex flex-column flex-sm-row gap-3 gap-lg-0 align-items-lg-center justify-content-lg-between justify-content-center">
                                ...
                                <p class="mb-0 text-center lead">&copy; <span class="dynamic-year"> </span>. Jadi Trip. All rights reserved</p>
                            </div>
                        </div>
